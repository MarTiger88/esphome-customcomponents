...
enum TB6612StepMode {
  TB6612_STEP_MODE_FULL_STEP,
  TB6612_STEP_MODE_HALF_STEP,
  TB6612_STEP_MODE_WAVE_DRIVE,
};

class TB6612 : public stepper::Stepper, public Component {
 public:
  ...
  void set_pin_e(GPIOPin *pin_e) { pin_e_ = pin_e; }
  ...
  void set_step_mode(TB6612StepMode step_mode) { this->step_mode_ = step_mode; }
 ...
 protected:
  ...
  GPIOPin *pin_d_;
  GPIOPin *pin_e_;
  TB6612StepMode step_mode_{TB6612_STEP_MODE_FULL_STEP};
